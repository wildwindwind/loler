...
<script type="text/javascript">
	...
	function refreshCaptcha(){
		...
		$('#captchaImg').attr('src','${base}/admin/captcha.htm?r='+Math.random());
	}
		...
		<div class="login_form">
			<div class="form_info">
				...
				<div class="field">
                    ...
                    <img id="captchaImg" title="看不清？请点击图片更换！" align="absmiddle" src="${base}/admin/captcha.htm" onclick="refreshCaptcha();" style="cursor:pointer"/>
				</div>
				<div class="field">
